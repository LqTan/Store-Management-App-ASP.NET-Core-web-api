        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRegistrationDate = table.Column<DateOnly>(type: "date", nullable: true),
                    UserLastLoginDate = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountEffectiveStart = table.Column<DateOnly>(type: "date", nullable: true),
                    DiscountEffectiveEnd = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentCarrierId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Shipments_ShipmentCarriers_ShipmentCarrierId",
                        column: x => x.ShipmentCarrierId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_ShipmentCarrierId",
                table: "Shipments",
                column: "ShipmentCarrierId");
        }
