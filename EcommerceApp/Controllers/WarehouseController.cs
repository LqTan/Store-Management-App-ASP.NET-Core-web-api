...
namespace EcommerceApp.Controllers
{
    ...
    {
        private readonly IWarehouseRepository repo;
        ...
        public async Task<IActionResult> Add(WarehouseModel model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = AppRole.Admin)]
        public async Task<IActionResult> Update(int id, WarehouseModel model)
        {
